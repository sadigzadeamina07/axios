...
if(loading) return <div className="w-16 h-16 m-auto border-4 border-dashed rounded-full animate-spin dark:border-violet-600"></div>
  return (
...
{user.map((item)=>(
  <div key={item.id} className="rounded-md shadow-md sm:w-full mx-[5px] dark:bg-gray-50 dark:text-gray-800">
	<div className="flex   items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			<img src="/user.png" alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-indigo-500 dark:border-gray-300" />
		...
		<div className="flex flex-wrap items-center pt-3 pb-1">
			<div className="flex items-center space-x-2">
				<div className="flex -space-x-1">
					<img alt="" className="w-5 h-5 border rounded-full dark:bg-gray-500 dark:border-gray-100" src="/user.png" />
					<img alt="" className="w-5 h-5 border rounded-full dark:bg-gray-500 dark:border-gray-100" src="/user.png" />
					<img alt="" className="w-5 h-5 border rounded-full dark:bg-gray-500 dark:border-gray-100" src="/user.png" />
				</div>
